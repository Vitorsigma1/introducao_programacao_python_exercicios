...
taxa_juros = float(input("Digite a taxa de juros (ex: 0.5 para 0.5%): "))
...
print(f"\nEvolução da poupança:") # O 'f' vem de format e o Python entende que
# não é só uma frase e sim um modelo que pode conter cálculos e variáveis

print("_" * 30) # Gera 30 hífens sublinhando o cabeçalho

# Estrutura de repetição para os 24 meses
while mes <= 24:
    # Cálculo do juros do mês atual
    juros_do_mes = saldo * (taxa_juros / 100)
    # Atualização do saldo (Acumulador)
